...
// 2. Log the variable
<<<<<<< HEAD
var HIGHEST_REDUCTION = "https://www.dealabs.com/bons-plans/75-sur-la-gamme-lego-mario-parthenay-79-2972397";
...
prices.sort((a, b) => a - b);
//5e percentile (p5)
const p5Index = Math.ceil(0.05 * prices.length) - 1;
const p5Price = prices[p5Index];
//25e percentile (p25)
const p25Index = Math.ceil(0.25 * prices.length) - 1;
const p25Price = prices[p25Index];

console.log(`average : ${averagePrice.toFixed(2)} `);
console.log(`5e percentile (p5): ${p5Price.toFixed(2)}`);
console.log(`25e percentile (p25): ${p25Price.toFixed(2)}`);
...
<<<<<<< HEAD
const specific_item = VINTED.find(item => item.uuid === 'f2c5377c-84f9-571d-8712-98902dcbb913');
console.log(specific_item);

// 🎯 TODO 14: Delete a specific item
// 1. Delete the item with the uuid `f2c5377c-84f9-571d-8712-98902dcbb913`
// 2. Log the new list of items
const index_item = VINTED.findIndex(item => item.uuid === 'f2c5377c-84f9-571d-8712-98902dcbb913');

if (index_item !== -1) {
    VINTED.splice(index_item, 1);
}
...
<<<<<<< HEAD
const profitability =Math.max(...prices)-deal.retail;
...
console.log(localStorage.getItem('myFavoriteDealers'));
